...
class GameScene (QGraphicsScene) :
    ...
    def __init__( self ) :
        ...
        #Create a two-dimensional 150000 unit graphic item array corresponding each cell
    ...
    def mousePressEvent( self, event) :
        ...
        # Mouse coordinates have to be divided with 
        # cell widht and height in order to get them correctly  
    ...
    def mouseMoveEvent( self, event ) :
        ...
        # See event mousePressEvent. This event
        # applies while mouse is moving
    ...
    def calculateCells ( self ) :
        ...
        for x in range (149):
            for y in range (99):
                ...
                if((neighbours == 2 or neighbours == 3) and self.cells[x][y] > 0):
...
class LifeWindow( QWidget ) :
    ...
    def __init__(self, parent=None ) :
        ...
        # Set the LifeWindow widget to the middle of the screen and set default widht and height
        self.setGeometry( QApplication.desktop().width()/2, QApplication.desktop().height()/2, 655, 525 )
        # Add title
        ...
        self.connect( self.pushButtonStart, SIGNAL( "clicked()" ), self.pushButtonStart_clicked )
        self.connect( self.pushButtonPause, SIGNAL( "clicked()" ), self.pushButtonPause_clicked )
        self.connect( self.pushButtonNew, SIGNAL( "clicked()" ), self.pushButtonNew_clicked )
        ...
        # Create an instance of graphicsscene object called gamescene and set it as the
    ...
    def pushButtonStart_clicked( self ) :
        # Start the graphicsscenes own timer and start the whole game and its logic
    ...
    def pushButtonNew_clicked( self ) :
        # Stop the timer and call the graphicsscenes method clearScene
        # for a new start
        self.gameScene.timer.stop()
